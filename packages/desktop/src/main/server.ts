...
export function preferAppEnv(userDataPath: string) {
  ...
  Object.assign(process.env, {
    ...
    // Redirect all core engine data (database, JSON storage, config) to APPDATA
    // so everything lives under one directory instead of scattering across ~/.local/share and ~/.config

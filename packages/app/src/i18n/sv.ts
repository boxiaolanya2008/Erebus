export const dict = {
  ...
  "settings.general.row.gpuAcceleration.description": "Enable GPU rasterization, zero-copy compositing, and accelerated 2D canvas for faster rendering",
  "settings.general.row.gpuRendering.title": "GPU-Accelerated Rendering",
  "settings.general.row.gpuRendering.description": "Use GPU compositing for model messages, thinking blocks, and markdown rendering",

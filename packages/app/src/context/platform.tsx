...
type PlatformBase = {
  ...
  /** Get whether GPU hardware acceleration is enabled (desktop only) */
  getGpuAcceleration?(): Promise<boolean> | boolean

  /** Enable/disable GPU hardware acceleration — requires relaunch (desktop only) */
  setGpuAcceleration?(enabled: boolean): Promise<void> | void

  /** Get whether GPU-accelerated rendering for messages/thinking is enabled (desktop only) */
  getGpuRendering?(): Promise<boolean> | boolean

  /** Enable/disable GPU-accelerated rendering for messages/thinking (desktop only) */
  setGpuRendering?(enabled: boolean): Promise<void> | void
